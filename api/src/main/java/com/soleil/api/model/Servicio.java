...
public class Servicio {
    ...
    public Servicio(LocalDate fecha_cita, Empleado dni_empleado, Paciente dni_paciente, Tratamiento id_tratamiento, String modo_pago, Double tarifa, String concepto, int num_sesiones) {
